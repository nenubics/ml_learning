...
Этот репозиторий представляет собой современную персональную базу знаний (**Second Brain / PKM**) по **Машинному обучению (Machine Learning)** и **Глубокому обучению (Deep Learning)**, оформленную в стандартах **Obsidian**.
